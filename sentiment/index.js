...
app.post('/sentiment', async (req, res) => {
    ...
    // Note: The hint suggests req.query, but typically POST data is in req.body. 
    // Following hint's instruction for req.query:
    ...
    try {
        ...
        // Task 6: send a status code of 200 with both sentiment score and sentiment txt
